...
void Graph::queuePush(int x) {this->queue[this->R++] = x;} // add to the queue 
                                        // R++ - the next element
                                        // queue size increases by R++

int Graph::queuePop() {return this->queue[this->L++];} // extract element from the start of the queue
                                    // queue size decreases by L++

int Graph::queueSize() {return (this->R - this->L);} // returns queue size

// keping graphs

/* inputs connected nodes and edges weight forming an adjacency matrix */
vector<vector<int>> Graph::form_matrix(int nodes_count, int edges_count, bool directed, bool weighted) {
...
vector<vector<int>> Graph::form_adjacency_list(int nodes_count, int edges_count, bool directed) {
...
/*   DFS   */
void Graph::dfs(vector<vector<int>> graph, int v) {
    // marking node
    visited[v] = true; 
...
/*   BFS   */
void Graph::bfs(vector<vector<int>> graph, int v) {
...
void Graph::print_adjacency_list(vector<vector<int>> adjacency_list) {
